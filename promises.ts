...
function task1(time:number,data:string):Promise<string>{
...
function task2(time:number,data:string):Promise<string>{
...
function task3(time:number,data:string):Promise<string>{
...
let p2:Promise<string>  = task1(800,"4")
.then((res)=>{
    // post task completion sucessfully here we can call the next task
    console.log(res);
...
p2.then((res)=>{ // callback for task2
    console.log(res);
})
